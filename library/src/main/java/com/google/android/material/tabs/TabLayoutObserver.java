...
public final class TabLayoutObserver {
    ...
    @NonNull private final GridPagerLayoutManager gridPager;
    ...
    public TabLayoutObserver(@NonNull TabLayout tabLayout, @NonNull GridPagerLayoutManager gridPager, @NonNull TabConfigurationStrategy tabConfigurationStrategy) {
        this(tabLayout, gridPager, /* autoRefresh= */ true, tabConfigurationStrategy);
    }

    public TabLayoutObserver(@NonNull TabLayout tabLayout, @NonNull GridPagerLayoutManager gridPager, boolean autoRefresh, @NonNull TabConfigurationStrategy tabConfigurationStrategy) {
        this(tabLayout, gridPager, autoRefresh, /* smoothScroll= */ true, tabConfigurationStrategy);
    }

    public TabLayoutObserver(@NonNull TabLayout tabLayout, @NonNull GridPagerLayoutManager gridPager, boolean autoRefresh, boolean smoothScroll, @NonNull TabConfigurationStrategy tabConfigurationStrategy) {
    ...
    private static class TabLayoutOnPageChangeCallback extends GridPagerLayoutManager.OnPageChangeListener {
    ...
    private static class ViewPagerOnTabSelectedListener implements TabLayout.OnTabSelectedListener {
        private final GridPagerLayoutManager viewPager;
        private final boolean smoothScroll;

        ViewPagerOnTabSelectedListener(GridPagerLayoutManager viewPager, boolean smoothScroll) {
