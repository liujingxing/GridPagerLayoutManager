...
public final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private final @NonNull GridPagerLayoutManager mLayoutManager;
    ...
    public ScrollEventAdapter(@NonNull GridPagerLayoutManager layoutManager) {
    ...
    private void updateScrollEventValues() {
        ...
        GridPagerLayoutManager.LayoutParams layoutParams = (GridPagerLayoutManager.LayoutParams) snapView.getLayoutParams();
    ...
    private void dispatchStateChanged(@ScrollState int state) {
        ...
        Log.d("LJX", "dispatchStateChanged state=" + state);
    ...
    private void dispatchSelected(int target) {
        Log.e("LJX", "dispatchSelected target=" + target);
        if (mCallback != null) {
...
//        Log.e("LJX", "dispatchScrolled position=" + position + " offset=" + offset + " offsetPx=" + offsetPx);
        if (mCallback != null) {
